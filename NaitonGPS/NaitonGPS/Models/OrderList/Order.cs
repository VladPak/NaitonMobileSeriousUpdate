...
namespace NaitonGPS.Models
{
	public class Order
    {
        ...
        public int? CreatedByEmployeeId { get; internal set; }
        ...
        public int? FreeDeliveryAmount { get; internal set; }
        public string PaymentMethod { get; internal set; }
        public decimal PaymentSumWithoutTax { get; internal set; }
        public decimal DeliverySumWithoutTax { get; internal set; }
