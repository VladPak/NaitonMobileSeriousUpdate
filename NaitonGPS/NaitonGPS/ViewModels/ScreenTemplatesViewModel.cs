...
{
	public static class ScreenTemplatesViewModel
	{
		public static List<ShellContentModel> Screens = new List<ShellContentModel>()
			{
				new ShellContentModel
				{
					RoleRight =Services.RoleManager.PICK_LIST ,
					Title = "Picklist",
					Icon = "picklist.png",
					Route = "PickList",
					ContentTemplate = new DataTemplate(typeof(PickListPage))
				},
				new ShellContentModel
				{
					RoleRight = Services.RoleManager.INVENTORY_COUNT,
					Title = "Count",
					Icon = "crossdock.png",
					Route = "InventoryCount",
					ContentTemplate = new DataTemplate(typeof(InventoryCountListPage))
				},
				new ShellContentModel
				{
					RoleRight = Services.RoleManager.SHOW_CURRENT_QUANTITY,
					Title = "Show current quantity",
					Icon = "",
					Route = "InventoryCount",
					ContentTemplate = new DataTemplate(typeof(InventoryCountDetailsPage))
				},
				new ShellContentModel
				{
					RoleRight =Services.RoleManager.ADD_RANDOM_RACK,
					Title = "Add random rack",
					Icon = "",
					Route = "InventoryCount",
					ContentTemplate = new DataTemplate(typeof(InventoryCountDetailsPage))
				}
